pipeline {
    ...
    stages {
        ...
        stage('\u27A1 Master-Inflate variables.json') {
            ...
            steps {
                sh 'cp /home/admini/debian10/variables.json $WORKSPACE/debian10/variables.json'
            }
        }
        stage('\u27A1 Inflate variables.json') {
            ...
            steps {
                sh 'cp /home/admini/debian10/notmaster-variables.json $WORKSPACE/debian10/notmaster-variables.json'
            }
        }
